...
class Area12Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area12', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area12')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area12')->with('success', 'Dokumen Area12 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area12', $document->id);
        } else {
