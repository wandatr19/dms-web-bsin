...
class Area14Controller extends Controller
{
    public function index()
    {
        $documents = Document::orderBy('doc_name')->get();
        return view('area.area14', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area14')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area14')->with('success', 'Dokumen Area14 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area14', $document->id);
        } else {
