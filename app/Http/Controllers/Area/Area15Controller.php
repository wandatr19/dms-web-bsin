...
class Area15Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area15', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area15')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area15')->with('success', 'Dokumen Area15 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area15', $document->id);
        } else {
