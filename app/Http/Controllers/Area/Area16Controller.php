...
class Area16Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area16', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area16')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area16')->with('success', 'Dokumen Area16 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area16', $document->id);
        } else {
