...
class Area18Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area18', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area18')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area18')->with('success', 'Dokumen Area18 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area18', $document->id);
        } else {
