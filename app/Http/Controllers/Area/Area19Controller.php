...
class Area19Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area19', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area19')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area19')->with('success', 'Dokumen Area19 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area19', $document->id);
        } else {
