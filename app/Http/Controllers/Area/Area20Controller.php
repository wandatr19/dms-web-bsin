...
class Area20Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area20', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area20')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area20')->with('success', 'Dokumen Area20 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area20', $document->id);
        } else {
