...
class Area26Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area26', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area26')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area26')->with('success', 'Dokumen Area26 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area26', $document->id);
        } else {
