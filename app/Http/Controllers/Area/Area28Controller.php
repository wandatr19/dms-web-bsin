...
class Area28Controller extends Controller
{
    public function index()
    {
        $documents = Document::orderBy('doc_name')->get();
        return view('area.area28', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area28')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area28')->with('success', 'Dokumen Area28 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area28', $document->id);
        } else {
