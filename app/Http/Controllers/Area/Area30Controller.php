...
class Area30Controller extends Controller
{
    public function index()
    {
        $documents = Document::orderBy('doc_name')->get();
        return view('area.area30', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area30')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area30')->with('success', 'Dokumen Area30 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area30', $document->id);
        } else {
