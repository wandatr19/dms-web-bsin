...
class Area32Controller extends Controller
{
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area32')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area32')->with('success', 'Dokumen Area32 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area32', $document->id);
        } else {
