...
class Area34Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area34', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area34')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area34')->with('success', 'Dokumen Area34 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area34', $document->id);
        } else {
