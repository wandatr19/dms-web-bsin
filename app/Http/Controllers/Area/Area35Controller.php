...
class Area35Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area35', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area35')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area35')->with('success', 'Dokumen Area35 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area35', $document->id);
        } else {
