...
class Area36Controller extends Controller
{
    public function index()
    {
        $documents = Document::orderBy('doc_name')->get();
        return view('area.area36', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area36')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area36')->with('success', 'Dokumen Area36 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area36', $document->id);
        } else {
