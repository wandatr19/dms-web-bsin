...
class Area37Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area37', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area37')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area37')->with('success', 'Dokumen Area37 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area37', $document->id);
        } else {
