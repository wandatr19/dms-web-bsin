...
class Area38Controller extends Controller
{
    public function index()
    {
        $documents = Document::orderBy('doc_name')->get();
        return view('area.area38', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area38')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area38')->with('success', 'Dokumen Area38 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area38', $document->id);
        } else {
