...
class Area39Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area39', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area39')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area39')->with('success', 'Dokumen Area39 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area39', $document->id);
        } else {
