...
class Area40Controller extends Controller
{
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area40')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area40')->with('success', 'Dokumen Area40 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area40', $document->id);
        } else {
