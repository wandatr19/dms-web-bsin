...
class Area41Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area41', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area41')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area41')->with('success', 'Dokumen Area41 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area41', $document->id);
        } else {
