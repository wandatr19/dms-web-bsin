...
class Area43Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area43', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area43')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area43')->with('success', 'Dokumen Area43 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area43', $document->id);
        } else {
