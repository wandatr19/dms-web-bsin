...
class Area44Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area44', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area44')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area44')->with('success', 'Dokumen Area44 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area44', $document->id);
        } else {
