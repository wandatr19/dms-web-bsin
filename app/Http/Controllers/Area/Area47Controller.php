...
class Area47Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area47', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area47')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area47')->with('success', 'Dokumen Area47 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area47', $document->id);
        } else {
