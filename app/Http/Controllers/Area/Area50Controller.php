...
class Area50Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area50', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area50')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area50')->with('success', 'Dokumen Area50 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area50', $document->id);
        } else {
