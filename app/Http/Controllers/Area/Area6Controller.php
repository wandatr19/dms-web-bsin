...
class Area6Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area6', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area6')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area6')->with('success', 'Dokumen Area6 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area6', $document->id);
        } else {
