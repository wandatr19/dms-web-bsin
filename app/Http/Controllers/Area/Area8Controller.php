...
class Area8Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('area.area8', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Area8')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Area8')->with('success', 'Dokumen Area8 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Area8', $document->id);
        } else {
