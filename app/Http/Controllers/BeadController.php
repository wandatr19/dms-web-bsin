...
class BeadController extends Controller
{
    public function index()
    {
        ...
        return view('mechanical.layer2.bead', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('bead')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('bead')->with('success', 'Dokumen Bead Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-bead', $document->id);
        } else {
