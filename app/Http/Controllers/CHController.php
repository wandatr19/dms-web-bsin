...
class CHController extends Controller
{
    public function index()
    {
        ...
        return view('mechanical.layer2.cement_house', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('CH')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('CH')->with('success', 'Dokumen CementHouse Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-CH', $document->id);
        } else {
