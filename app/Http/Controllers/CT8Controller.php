...
class CT8Controller extends Controller
{
    public function index()
    {
        $documents = Document::orderBy('doc_name')->get();
        return view('mechanical.layer2.8ct', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('CT8')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('CT8')->with('success', 'Dokumen 8CT Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-CT8', $document->id);
        } else {
