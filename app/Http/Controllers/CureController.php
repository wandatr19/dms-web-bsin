...
class CureController extends Controller
{
    public function index()
    {
        ...
        return view('mechanical.layer2.cure', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('cure')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('cure')->with('success', 'Dokumen cure Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-cure', $document->id);
        } else {
