...
class E1NDCTController extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('electrical.layer2.e1ndct', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('E1NDCT')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('E1NDCT')->with('success', 'Dokumen E1/N-DCT Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-E1NDCT', $document->id);
        } else {
