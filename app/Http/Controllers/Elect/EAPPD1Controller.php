...
class EAPPD1Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('electrical.layer2.eappd1', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('EAPPD1')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('EAPPD1')->with('success', 'Dokumen EAPPD1 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-EAPPD1', $document->id);
        } else {
