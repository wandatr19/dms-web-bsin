...
class EBeadController extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('electrical.layer2.ebead', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('EBead')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('EBead')->with('success', 'Dokumen EBead Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-EBead', $document->id);
        } else {
