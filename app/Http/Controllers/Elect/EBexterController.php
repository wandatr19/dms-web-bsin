...
class EBexterController extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('electrical.layer2.ebexter', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('EBexter')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('EBexter')->with('success', 'Dokumen EBexter Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-EBexter', $document->id);
        } else {
