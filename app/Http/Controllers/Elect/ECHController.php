...
class ECHController extends Controller
{
    public function index()
    {
        $documents = Document::orderBy('doc_name')->get();
        return view('electrical.layer2.ech', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('ECH')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('ECH')->with('success', 'Dokumen ECementHouse Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-ECH', $document->id);
        } else {
