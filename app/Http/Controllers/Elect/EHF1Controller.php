...
class EHF1Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('electrical.layer2.ehf1', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('EHF1')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('EHF1')->with('success', 'Dokumen EHF1 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-EHF1', $document->id);
        } else {
