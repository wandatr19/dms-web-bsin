...
class EK1SController extends Controller
{
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('EK1S')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('EK1S')->with('success', 'Dokumen EK1S Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-EK1S', $document->id);
        } else {
