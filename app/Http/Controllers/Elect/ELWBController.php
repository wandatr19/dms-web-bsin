...
class ELWBController extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('electrical.layer2.elwb', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('ELWB')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('ELWB')->with('success', 'Dokumen ELWBuff Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-ELWB', $document->id);
        } else {
