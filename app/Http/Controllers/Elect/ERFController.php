...
class ERFController extends Controller
{
    public function index()
    {
        ...
        return view('electrical.layer2.erf', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('ERF')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('ERF')->with('success', 'Dokumen ERimFlow Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-ERF', $document->id);
        } else {
