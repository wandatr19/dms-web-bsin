...
class ERTBController extends Controller
{
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('ERTB')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('ERTB')->with('success', 'Dokumen ERTB Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-ERTB', $document->id);
        } else {
