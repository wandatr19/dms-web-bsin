...
class EReworkController extends Controller
{
    public function index()
    {
        $documents = Document::orderBy('doc_name')->get();
        return view('electrical.layer2.erework', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('ERework')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('ERework')->with('success', 'Dokumen ERework Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-ERework', $document->id);
        } else {
