...
class ETRController extends Controller
{
    public function index()
    {
        ...
        return view('electrical.layer2.etr', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('ETR')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('ETR')->with('success', 'Dokumen ETireRepair Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-ETR', $document->id);
        } else {
