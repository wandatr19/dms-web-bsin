...
class EWB2Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('electrical.layer2.ewb2', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('EWB2')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('EWB2')->with('success', 'Dokumen EWhiteBuff2 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-EWB2', $document->id);
        } else {
