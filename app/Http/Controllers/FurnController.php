...
class FurnController extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('mechanical.layer2.furniture', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Furn')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Furn')->with('success', 'Dokumen Furniture Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Furn', $document->id);
        } else {
