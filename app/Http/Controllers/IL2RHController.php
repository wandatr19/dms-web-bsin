...
class IL2RHController extends Controller
{
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('IL2RH')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('IL2RH')->with('success', 'Dokumen IL2RH Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-IL2RH', $document->id);
        } else {
