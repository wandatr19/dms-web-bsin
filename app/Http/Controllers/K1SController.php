...
class K1SController extends Controller
{
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('K1S')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('K1S')->with('success', 'Dokumen K1S Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-K1S', $document->id);
        } else {
