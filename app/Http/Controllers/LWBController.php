...
class LWBController extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('mechanical.layer2.lw_buff', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('LWB')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('LWB')->with('success', 'Dokumen LWBuff Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-LWB', $document->id);
        } else {
