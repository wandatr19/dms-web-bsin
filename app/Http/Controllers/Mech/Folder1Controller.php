...
namespace App\Http\Controllers\Mech;
...
class Folder1Controller extends Controller
{
    public function index()
    {
        $documents = Document::orderBy('doc_name')->get();
        return view('mechanical.layer2.folder1', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Folder1')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Folder1')->with('success', 'Dokumen Folder1 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Folder1', $document->id);
        } else {
