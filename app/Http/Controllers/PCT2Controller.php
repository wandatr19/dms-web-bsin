...
class PCT2Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('mechanical.layer2.plycutting2', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('PCT2')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('PCT2')->with('success', 'Dokumen PCT2 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-PCT2', $document->id);
        } else {
