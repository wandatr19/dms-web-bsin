...
class PSPController extends Controller
{
    public function index()
    {
        ...
        return view('mechanical.layer2.psp', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('PSP')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('PSP')->with('success', 'Dokumen PSP Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-PSP', $document->id);
        } else {
