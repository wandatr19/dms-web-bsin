...
class RFController extends Controller
{
    public function index()
    {
        ...
        return view('mechanical.layer2.rim_flow', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('RF')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('RF')->with('success', 'Dokumen Rim Flow Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-RF', $document->id);
        } else {
