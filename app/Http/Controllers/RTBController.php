...
class RTBController extends Controller
{
    public function index()
    {
        ...
        return view('mechanical.layer2.rtb', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('RTB')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('RTB')->with('success', 'Dokumen RTB Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-RTB', $document->id);
        } else {
