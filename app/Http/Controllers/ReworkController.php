...
class ReworkController extends Controller
{
    public function index()
    {
        ...
        return view('mechanical.layer2.rework', compact('documents'));
    }
    public function upload(Request $request)
    {
        activity()->withoutLogs(function () use ($request) {
            if ($request->hasFile('file')) {
                ...
                $path = $file->store('mechanical/Rework', 'public');
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('Rework')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('Rework')->with('success', 'Dokumen Rework Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-Rework', $document->id);
        } else {
