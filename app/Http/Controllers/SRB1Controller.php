...
class SRB1Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('mechanical.layer2.srbelt1', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('SRB1')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('SRB1')->with('success', 'Dokumen SR Belt 1 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-SRB1', $document->id);
        } else {
