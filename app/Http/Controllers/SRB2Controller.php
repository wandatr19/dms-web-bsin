...
class SRB2Controller extends Controller
{
    public function index()
    {
        $documents = Document::all();
        return view('mechanical.layer2.srbelt2', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('SRB2')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('SRB2')->with('success', 'Dokumen SR Belt 2 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-SRB2', $document->id);
        } else {
