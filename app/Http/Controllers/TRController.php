...
class TRController extends Controller
{
    public function index()
    {
        ...
        return view('mechanical.layer2.tire_repair', compact('documents'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('TR')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('TR')->with('success', 'Dokumen TireRepair Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-TR', $document->id);
        } else {
