...
class WB2Controller extends Controller
{
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('WB2')->with('success', 'Dokumen Berhasil Dihapus!');
    }
    public function destroy($category)
    {
        ...
        return redirect()->route('WB2')->with('success', 'Dokumen WhiteBuff2 Berhasil Dihapus');
    }
    public function password(Request $request, $id)
    {
        ...
        if ($password === $passwordDoc->password) {
            return redirect()->route('open-WB2', $document->id);
        } else {
